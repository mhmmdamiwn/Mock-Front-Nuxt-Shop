<template>
  ...
  -->
    ...
    -->
                  ...
                  <div class="border-b border-gray-200">
                     <div class="-mb-px flex space-x-8 px-4" aria-orientation="horizontal" role="tablist">
                        ...
                        <button id="tabs-1-tab-1"
                           class="border-transparent text-red-600 flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-bold"
                           aria-controls="tabs-1-panel-1" role="tab" type="button">KWC</button>
                        <!-- Selected: "border-indigo-600 text-indigo-600", Not Selected: "border-transparent text-gray-900" -->
      ...
      <header class="relative bg-white border-10 border-black">
               ...
               <div class="flex h-16 items-center">
                  ...
                  <div class="ml-4 flex lg:ml-0">
                     <a href="#">
                        ...
                        <img class="h-8 w-auto" src="~/assets/images/KWC_logo.svg.png"
                           alt="">
                     </a>
                  </div>
      ...
      <div class="flex flex-col bg-rose-200 min-h-[100vh] w-full">
      </div>
   </div>
</template>